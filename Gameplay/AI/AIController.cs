...
namespace SpaceShooter
{
    ...
    public class AIController : MonoBehaviour
    {
        ...
        private void ActionFindNewMovePosition()
        {
            ...
            if (m_AIBehaviour == AIBehaviour.Patrol)
            {
                ...
                else
                {
                    ...
                    {
                        bool isInsidePatrolZone = (m_PatrolPoints[m_PointIndex].transform.position - transform.position).sqrMagnitude
                        ...
                        if (isInsidePatrolZone == true) // Near patrol point
                        {
                            ...
                            {
                                Vector2 newPoint = UnityEngine.Random.onUnitSphere * m_PatrolPoints[m_PointIndex].Radius
                                    + m_PatrolPoints[m_PointIndex].transform.position;
        ...
        //    // переход с фазы упреждения на фазу измерения скорости
        ...
        //    // в конце измерения, в начале фазы, при которой действует упреждение 
        ...
        //        // перемещение за фазу измерения скорости секундомером.
        //        Vector3 displacement = targetPos1 - targetPos0;

        //        // умножить на отношение всего цикла упреждения к фазе измерения
        ...
        public void SetPatrolPoints(AIPointPatrol[] patrolPoints)
        {
